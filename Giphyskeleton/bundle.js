...
function (_React$Component) {
  ...
  _createClass(GiphysSearch, [{
    ...
    value: function componentDidMount() {
      this.props.fetchSearchGiphys('the+office');
    }
  }, {
    key: "handleChange",
    ...
    value: function render() {
      ...
      }, "Search GIF")), react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement(_giphys_index__WEBPACK_IMPORTED_MODULE_1__["default"], {
        giphys: giphys
      }));
    }
  }]);
...
var fetchSearchGiphys = function fetchSearchGiphys(searchTerm) {
  return $.ajax({
    method: 'GET',
    url: "http://api.giphy.com/v1/gifs/search?q=".concat(searchTerm, "&api_key=eviHpKKJErZhwu2LnExsrINqIDP4Srap&limit=4")
  });
};
