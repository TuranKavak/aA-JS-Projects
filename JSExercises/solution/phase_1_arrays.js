...
Array.prototype.twoSum2 = function() {
  ...
  this.forEach((el, idx) => {
    // console.log('indexHash1:');
    // console.log(indexHash);
      if (indexHash[el * -1]) {
        // console.log('indexHash2:');
        // console.log(indexHash);
      // console.log('indexHashElMinus1:')
      // console.log(indexHash[el * -1]);
      const newPairs = indexHash[el * -1].map((prevIdx) => [prevIdx, idx]);
        // console.log('newPairs:');
        // console.log(newPairs);
        // console.log('indexHash3:');
        // console.log(indexHash);
