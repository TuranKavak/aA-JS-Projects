...
function Course(cname, department, credits, days, block) {
    this.cname = cname;
...
let course1 = new Course("101", "CS", 3, ["mon", "wed", "fri"], 3);
let course2 = new Course("201", "CS", 3, ["wed"], 4);
let course3 = new Course("301", "ENG", 3, ["tue"], 5);
...
// console.log('should be true = ' + course1.conflictsWith(course2)); changed the input course
