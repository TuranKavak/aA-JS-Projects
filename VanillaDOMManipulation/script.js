document.addEventListener("DOMContentLoaded", () => {
    ...
    const handeFavoriteSubmit = (e) => {
        e.preventDefault();

        const favoriteInput = document.querySelector('.favorite-input');
        const favoritePlace = favoriteInput.value;
        favoriteInput.value = "";
    ...
    listSubmitButton.addEventListener("click", handeFavoriteSubmit);




    // adding new photos
    // on click auf button neues bild 
    // --- your code here!
