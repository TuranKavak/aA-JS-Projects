...
describe("Board", function() {
    ...
    describe("#_positionsToFlip", function() {
        ...
        it("returns positions for longer horizontal and vertical cases ", function() {
            //long vertical cases
            assert.equal(JSON.stringify(testBoardLongHorzDiagonal._positionsToFlip([1, 0], "white", [1, 0])), JSON.stringify([
                [2, 0],
                [3, 0],
                [4, 0]
            ]));
            assert.equal(JSON.stringify(testBoardLongHorzDiagonal._positionsToFlip([5, 7], "white", [-1, 0])), JSON.stringify([
                [4, 7],
                [3, 7],
                [2, 7]
            ]));
            ...
            assert.equal(JSON.stringify(testBoardLongHorzDiagonal._positionsToFlip([6, 1], "black", [0, 1])), JSON.stringify([
                [6, 2],
                [6, 3],
                [6, 4],
                [6, 5]
            ]));
            assert.equal(JSON.stringify(testBoardLongHorzDiagonal._positionsToFlip([7, 6], "black", [0, -1])), JSON.stringify([
                [7, 5],
                [7, 4],
                [7, 3],
                [7, 2]
        ...
        it("returns positions for longer diagonal cases", function() {
            assert.equal(JSON.stringify(testBoardLongHorzDiagonal._positionsToFlip([5, 2], "white", [-1, 1])), JSON.stringify([
                [4, 3],
                [3, 4],
                [2, 5]
            ]));
            assert.equal(JSON.stringify(testBoardLongHorzDiagonal._positionsToFlip([5, 5], "black", [-1, -1])), JSON.stringify([
                [4, 4],
                [3, 3],
                [2, 2]
            ]));

            assert.equal(JSON.stringify(testBoardLongHorzDiagonal._positionsToFlip([0, 2], "white", [1, 1])), JSON.stringify([
                [1, 3],
                [2, 4],
                [3, 5]
            ]));
            assert.equal(JSON.stringify(testBoardLongHorzDiagonal._positionsToFlip([0, 5], "black", [1, -1])), JSON.stringify([
                [1, 4],
                [2, 3],
                [3, 2]
            ]));
